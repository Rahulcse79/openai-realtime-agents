...
export const hospitalAiAgent = new RealtimeAgent({
  name: "hospitalAiAgent",
  voice: "sage",
...
export const HospitalAiAgent = [hospitalAiAgent];
export const HospitalAiAgentCompanyName = "Taj Hotel";

export default hospitalAiAgent;